...
export class ItinerarySummary extends Component {
  ...
  render () {
    ...
    const carbonEmissions = calculateEmissions(itinerary, {},'pound')
    console.log("emisisons: " + carbonEmissions);
    return (
      <Container onClick={this._onSummaryClicked}>
        <Details>
          ...
          {/* Fare / Calories */}
          <Detail>
            {minTotalFare > 0 && maxTotalFare > 0 && <span>
              <FormattedMessage
            ...
            <span>
            <i class="fa fa-heartbeat" style ={{color: '#D0312D'}}></i>
            <FormattedMessage
