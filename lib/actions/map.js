  ...
  return function (dispatch, getState) {
    ...
    if (payload.reverseGeocode) {
      ...
      .then((r) => {
        ...
        console.log("coords (on drag) ", coordinates)
        console.log("address (on drag) ", label)
  ...
  return function (dispatch, getState) {
    ...
    client
      ...
      .then((r) => {
        ...
        const coordinates = r.data.results[0].geometry.location; // {lat: value, lng: value}
        console.log("coords on click ", coordinates)
        console.log("address on click ", label)
        console.log("payload ", mapEvent)
